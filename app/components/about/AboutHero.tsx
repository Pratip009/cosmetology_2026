    ...
    <>
      <style>{`
        ...
        .ah-img {
          position: absolute;
          inset: -10% 0;
          background-image: url('https://images.unsplash.com/photo-1516975080664-ed2fc6a32937?w=1200&q=85');
      ...
      <section className="ah-section">
        ...
        <div className="ah-content">
          <p className="ah-eyebrow">Who We Are</p>

          <h1 className="ah-title">
            About Cosmetology School<br />
            of <em>Jersey City</em>
          </h1>

          <div className="ah-rule" />

          <p className="ah-body">
            CSJC is a New Jersey State Board of Cosmetology &amp; Hairstyling
            approved school offering five professional programs. Committed to
            building strong foundations and preparing students for real-world
            careers in beauty.
          </p>
        </div>
