...
export default function CalendarHero() {
    ...
    <>
      <style>{`
        ...
        .ah-img {
          position: absolute;
          inset: -10% 0;
          background-image: url('https://images.unsplash.com/photo-1649298173603-9c95aa950879?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D');
  ...
  <p className="ah-eyebrow">Book Your Session</p>
  ...
  <p className="ah-body">
    Choose a convenient date and time to connect with our team. Whether you have questions about programs, admissions, or career opportunities, we’re here to help you get started.
  </p>
</div>
